...
/* harmony import */ var _functions_accordeon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/accordeon */ "./src/js/functions/accordeon.js");
/* harmony import */ var _functions_accordeon__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_functions_accordeon__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _functions_upload_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/upload.js */ "./src/js/functions/upload.js");
/* harmony import */ var _functions_validate_reply_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/validate-reply.js */ "./src/js/functions/validate-reply.js");
/* harmony import */ var _functions_validate_reply_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_functions_validate_reply_js__WEBPACK_IMPORTED_MODULE_4__);
...
const scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_1___default())('a[href*="#statistics"], a[href*="#methods"]');

// Подключение аккордеона

// console.log(accordeon())

// Подключение загрузки картинок с превью

(0,_functions_upload_js__WEBPACK_IMPORTED_MODULE_3__.upload)('#file', {
  // multi: true,
...
// Подключение валидации отправки комментария
...
let acc = document.getElementsByClassName("accordeon__btn");
let i;
...
const element = function (tag) {
  ...
  let content = arguments.length > 2 ? arguments[2] : undefined;
...
/***/ "./src/js/functions/validate-reply.js":
/*!********************************************!*\
  !*** ./src/js/functions/validate-reply.js ***!
  \********************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  validateReply.addEventListener("click", function (event) {
    ...
    if (validateClick === 1 && textarea !== "") {
      const messageSubmit = document.querySelector(".text-field__submit--success");
